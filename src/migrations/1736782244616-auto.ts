...
export class Auto1736782244616 implements MigrationInterface {
    name = 'Auto1736782244616'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tg_bot_messages_messagetype_enum" AS ENUM('bot', 'user')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."tg_bot_messages_messagetype_enum"`);
